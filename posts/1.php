...
<div class="ufo--case-study-container project">
    ...
    <section id="section-0" class="ufo--case-study-section p_section p_section--header-main  "
        ...
        <div class="ufo--p-container-fluid ">
            ...
            <div class="ufo--site-nav profile_theme_three ">
    ...
    <section id="section-1" class="ufo--case-study-section p_section p_section--columns"
            ...
            <div class="ufo--columns ufo--columns-2">
                ...
                <div class="ufo--column">
                    ...
                    <p>Conducting interviews, paper and digital wireframing, low and high-fidelity, prototyping,
                        ...
                        information architecture, and responsive design.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="section-2" class="ufo--case-study-section p_section p_section--text"
        style="padding-top: 110px;  padding-bottom: 0px;">
    ...
    <section id="section-3" class="ufo--case-study-section p_section p_section--media image "
        style="  padding-bottom: 110px;">

        <div class="ufo--p-container-fluid">
            <div class="media-container image-container--fluid display-mode--offgrid  " style="  padding-bottom: 0;">
                <div class="media-box  ">
        ...
        <div class="text-container">
            <div class="ufo--basic-text-area">
                <div class="h2" style="color: white">
                    1. Discovery<br><br>Build deep understanding and identify needs
                </div>
            </div>
        </div>
                ...
                <div class="ufo--p-container-fluid">
                    <div class="text-container">
                        ...
                        <p>These are exploratory conversations with the most relevant stakeholders and product users.
                            ...
                            the definition of objectives.</p>
                    </div>
                        ...
                        <div class="ufo--p-container-fluid">
                            <div class="text-container">
                                ...
                                <p>Reviewing all relevant literature about the project’s topic enhances our team’s
                                    ...
                                    data, and watching related videos on YouTube.</p>
                            </div>
